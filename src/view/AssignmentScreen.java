...
ResultSet rs;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\Lenovo\\Desktop\\scholar_final_project\\assessment.pdf"));
            doc.open();
//            doc.add(contentpanel);
            doc.add(new Paragraph("Defnition:  Python is an interpreted, object-oriented, high-level programming language with dynamic semantics. Its high-level built in data structures,"
