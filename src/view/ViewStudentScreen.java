 ...
 * @author Lenovo
 */
public class ViewStudentScreen extends javax.swing.JInternalFrame {
...
//        txt_emp.setText(String.valueOf(Emp.empId).toString());
 ...
 private void Update_table() {
    try{
        ...
        String sql ="select CONCAT(FirstName ,' ', SurName) as Name, Contact,Address, Gender,std_batch as Course from AddStudent";
