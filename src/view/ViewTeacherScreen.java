 ...
 * @author Lenovo
 */
public class ViewTeacherScreen extends javax.swing.JInternalFrame {
...
//        txt_emp.setText(String.valueOf(Emp.empId).toString());
 ...
 private void Update_table() {
    try{
        ...
        String sql ="select CONCAT(FirstName ,' ', SurName) as Name, Contact,Address, Gender,Course_name as Course from AddTeacher";
